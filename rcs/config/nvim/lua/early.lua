...
if utils.file_exists('${XDG_DATA_HOME}/asdf/shims/neovim-ruby-host') then
  vim.cmd "let g:ruby_host_prog = vim.fs.normalize('${XDG_DATA_HOME}/asdf/shims/neovim-ruby-host'))"
elseif utils.file_exists('~/.local/share/asdf/shims/neovim-ruby-host') then
  vim.cmd "let g:ruby_host_prog = vim.fs.normalize('~/.local/share/asdf/shims/neovim-ruby-host'))"
elseif utils.file_exists("/usr/bin/neovim-ruby-host") then
  vim.cmd "let g:ruby_host_prog = '/usr/bin/neovim-ruby-host'"
-- TODO: Add windows paths
end
...
if utils.file_exists('${XDG_DATA_HOME}/asdf/shims/neovim-node-host') then
  vim.cmd "let g:node_host_prog = vim.fs.normalize('${XDG_DATA_HOME}/asdf/shims/neovim-node-host'))"
elseif utils.file_exists('~/.local/share/asdf/shims/neovim-node-host') then
  vim.cmd "let g:node_host_prog = vim.fs.normalize('~/.local/share/asdf/shims/neovim-node-host'))"
elseif utils.file_exists("/usr/bin/neovim-node-host") then
  vim.cmd "let g:node_host_prog = '/usr/bin/neovim-node-host'"
-- TODO: Add windows paths
end
