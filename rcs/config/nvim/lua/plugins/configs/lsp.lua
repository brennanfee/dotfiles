...
local on_attach = function(clientId, bufnr)
  ...
  nmap("<leader>ls", vim.lsp.buf.signature_help(), "[L]sp [S]ignature")
  ...
  nmap("<leader>q", vim.diagnostic.setloclist(), "Diagnostics Setloclist")
  nmap("<leader>fm", vim.lsp.buf.format({ async = true }), "[F]ormat")
  nmap("<leader>wa", vim.lsp.buf.add_workspace_folder(), "[A]dd [W]orkspace Folder")
  nmap("<leader>wr", vim.lsp.buf.remove_workspace_folder(), "[R]emove [W]orkspace Folder")
